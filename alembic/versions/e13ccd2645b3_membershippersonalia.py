...
def upgrade():
    ...
    op.get_bind().execute(sa.text('INSERT INTO membership_personalia (user_uuid, address, postal_code, country_code, created, modified) (SELECT uuid, address, postal_code, country_code, NOW(), NOW() from "user");'))
