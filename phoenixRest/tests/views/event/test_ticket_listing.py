def test_event_ticket_listing(testapp, upcoming_event, ticket_types, admin_user, jeff_user):
    """Test that you can list tickets for an event"""
    ...
    res = testapp.get('/event/%s/ticket' % upcoming_event.uuid, headers=dict({
